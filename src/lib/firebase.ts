...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyC0ZTh6rcSCn5vTANp0CWKJ-aIZxx4vt90",
  authDomain:
    process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN ||
    "yen-yoga-dashboard.firebaseapp.com",
  projectId:
    process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "yen-yoga-dashboard",
  storageBucket:
    process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET ||
    "yen-yoga-dashboard.firebasestorage.app",
  messagingSenderId:
    process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "17255003511",
  appId:
    process.env.NEXT_PUBLIC_FIREBASE_APP_ID ||
    "1:17255003511:web:737c001d0e5e5debf25d72",
  measurementId:
    process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-XX91RY8C7H",
};
