                ...
                <div className="rounded-[2rem] bg-white/70 backdrop-blur-xl p-10 shadow-xl border border-white hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-fadeInUp animate-delay-400">
                  ...
                  <dl className="space-y-4 text-gray-600">
                    <div className="flex gap-4">
                      ...
                      <dd>
                        <p className="font-medium text-gray-900">123 Đường Yoga, Quận 1</p>
                    ...
                    <div className="flex gap-4">
                      ...
                      <dd className="flex items-center">
                        ...
                        <span className="ml-3 font-medium hover:text-primary-600 cursor-pointer transition-colors">+84 123 456 789</span>
                      </dd>
                    </div>
                    <div className="flex gap-4">
                      ...
                      <dd className="flex items-center">
                        ...
                        <span className="ml-3 font-medium hover:text-primary-600 cursor-pointer transition-colors">info@yenyoga.vn</span>
                      </dd>
                    </div>
                  </dl>
                </div>
